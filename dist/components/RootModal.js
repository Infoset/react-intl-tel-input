...
var RootModal = exports["default"] = function (_Component) {
  _inherits(RootModal, _Component);
  var _super = _createSuper(RootModal);
  function RootModal(props) {
    var _this;
    _classCallCheck(this, RootModal);
    _this = _super.call(this, props);
    _this.modalTarget = props.document.createElement('div');
  ...
  _createClass(RootModal, [{
    ...
    value: function render() {
      return _reactDom["default"].createPortal(_react["default"].createElement(_react["default"].Fragment, null, this.props.children), this.modalTarget);
    }
  }]);
  return RootModal;
}(_react.Component);
